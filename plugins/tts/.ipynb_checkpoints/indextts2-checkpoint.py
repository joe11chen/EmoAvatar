...
class IndexTTS2(BaseTTS):
    ...
    def synthesize_to_wav(self, text: str, emotion: EMOTION | str | None, voice: str | None, output_path: str) -> dict[str, Any]:
        tts_start = time.perf_counter()
        ...
        elif voice == "female.wav":
            ref_audio_path = self.default_female_ref
        elif voice == "male.wav":
            ref_audio_path = self.default_male_ref
        else:
            ref_audio_path = self._resolve_ref_audio_path(None)
